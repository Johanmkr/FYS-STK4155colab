...
\newcommand{\comment}[1]{\par \textcolor{yellow}{* \textit{#1}}}
\newcommand{\fillertext}[1][]{\par \colorbox{lime}{add filler text} \textcolor{lime}{#1}\par}
\newcommand{\wtf}[1][WTF]{\textcolor{purple}{#1}}
%\newcommand{\beginfeltcute}{\begin{tcolorbox}[width=\textwidth,colback={pink},title={Felt cute, might delete later},outer arc=0mm,colupper=black] }
%\newcommand{\endfeltcute}{\end{tcolorbox}}
