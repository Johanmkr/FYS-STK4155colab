...
\begin{itemize}
    ...
    \item[$\mathcal{L}$] \rephrase{Loss function $\mathcal{L}(\svec{\theta}; f, \mathcal{D})$ of $\svec{\theta}$ parametrised by the coordinates in the data set $\mathcal{D}$ and the function $f$ (often written as $\mathcal{L}(\svec{\theta})$ for ease of notation)}
...
\subsection*{Hyper parametersyntax}
\begin{itemize}
