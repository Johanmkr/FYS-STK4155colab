...
\subsection{Regression}\label{sec:regression}
    ...
    Since we want to fit a function to data points, the obvious way of measured the error from the output layer is by considering the mean squared error (MSE). Thus, our loss function will as given in \Eq{ridge_cost_function} with a tunable hyperparameter $\lambda$. 

    We may use a varying number of hidden layers and neurons, 
