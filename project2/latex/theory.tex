...
\subsection{Regression}\label{sec:regression}
    ...
    Since we want to fit a function to data points, the obvious way of measured the error from the output layer is by considering the mean squared error (MSE). Thus, our loss function will as given in \checkthis{\Eq{linear_regression_cost_function}} with a tunable hyperparameter $\lambda$. 
...
\subsection{Classification}\label{sec:classification}
    ...
    When evaluating the loss we use \Eq{logistic_cost_function}
