...
%To connect the following with what we have looked at so far, we can think of the weights and  the parameter vector $\svec{\theta}$
    ...
    \end{equation}
    We have that \Eq{init_xavier} is known as \textit{Xavier} initialisation, while \Eq{init_he} is known as \textit{He} initialisation.
