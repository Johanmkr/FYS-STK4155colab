\section{Analysis}\label{sec:analysis}
    ...
    \subsection{Regression analysis for Franke function}\label{sec:reganalysis_franke}
        ...
        \Fig{bias_variance_lasso} show the bias variance trade off for the lasso regression for $d=14$ made with a $k=10$ bootstrap, for computational efficiency. We draw from this that the lasso regression scheme has a low variance, but high bias for the $\lambda$ values considered.  
