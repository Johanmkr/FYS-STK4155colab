\section{Analysis}\label{sec:analysis}
    ...
    \subsection{Regression analysis for Franke function}\label{sec:reganalysis_franke}
        ...
        \subsubsection{OLS}\label{sec:olsanalysis}
            ...
            We take the analysis further and consider the bias-variance tradeoff, as explained in \Sec{bias_variance_tradeoff}. The result is shown in \Fig{bias_variance_ols} where we clearly see that for low-order polynomials the error occurs mostly from bias, and for high degrees from  variance. There is a tradeoff, where the total error switches main dependence from bias to variance, ultimately minimising it. In \Fig{bias_variance_ols} this  tradeoff can be found around polynomial degree $d\approx 5$.
