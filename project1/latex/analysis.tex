\section{Analysis}\label{sec:analysis}
    ...
    \subsection{Regression analysis for Franke function}\label{sec:reganalysis_franke}
        ...
        \subsubsection{Ridge}\label{sec:rigdeanalysis}
            ...
            We continue our analysis of the model using $d=5$, but now for ridge regression, where the free parameter will be the penalty term $\lambda$. 
    ...
    \begin{figure}
        ...
        \caption{Scaled terrain data representing a part of the Grand Canyon, downloaded from \citep{EarthExplorer}. We use every \nth{30} point in each direction of the original $300\cross 300$-cutout, leaving us with an $xy$-grid of $30\cross 30$ points.}
        \label{fig:gc_data}
    \end{figure}
