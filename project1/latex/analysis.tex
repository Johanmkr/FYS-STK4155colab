\section{Analysis}\label{sec:analysis}
    ...
    \subsection{Regression analysis for Franke function}\label{sec:reganalysis_franke}
        ...
        \begin{figure}
            ...
            \caption{Heatmap of the MSE as function of both polynomial degree $d\in[6,12]$ and penalty parameter $\lambda$ for the lasso analysis of the Franke function ($N=20, \eta=0.1$, generated with and 8-fold cross validation}
